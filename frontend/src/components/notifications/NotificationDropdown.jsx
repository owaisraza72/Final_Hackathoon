              ...
              <div className="max-h-[400px] overflow-y-auto custom-scrollbar bg-white">
                {isLoading ? (
                  <div className="p-16 flex flex-col items-center justify-center gap-4">
                    ...
                    <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Awaiting uplink...</span>
                  </div>
                  ...
                  <div className="p-16 text-center">
                    ...
                    <p className="text-[10px] text-slate-400 font-bold uppercase tracking-[0.2em]">Zero Pulse Events</p>
                  </div>
                ) : (
                        ...
                        <div className="flex gap-4">
                          ...
                          <div className="flex-1 min-w-0 pointer-events-none">
                            <div className="flex justify-between items-start mb-0.5">
                               <h5 className={`text-sm tracking-tight ${!n.isRead ? "font-black text-slate-900 uppercase" : "font-bold text-slate-600"}`}>
                                 {n.title}
                               </h5>
                               {!n.isRead && <Zap size={8} className="text-teal-500" fill="currentColor" />}
                            </div>
