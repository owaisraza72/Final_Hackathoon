    ...
    { header: "Email", accessor: "email" },
    {
      ...
      cell: (row) => (
        <div className="flex items-center gap-2">
          ...
          >
            {row.isActive ? "Operational" : "Deactivated"}
          </span>
        </div>
      ),
    },
    ...
    <div className="max-w-7xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
        <PageHeader
          ...
          description="Maintain and oversee the active medical task force within your clinical node."
        />
        <button
          onClick={() => {
            setIsEditMode(false);
          ...
          className="h-14 px-8 bg-slate-900 border-b-4 border-black hover:bg-teal-600 hover:border-teal-800 text-white text-[11px] font-black uppercase tracking-[0.2em] rounded-[20px] transition-all duration-300 shadow-2xl flex items-center justify-center gap-4 active:scale-95 group"
        >
          <UserPlus className="h-5 w-5 group-hover:rotate-90 transition-transform" />
      ...
      {isLoading ? (
        ...
        <div className="p-10 bg-red-50/50 border border-red-100 rounded-[32px] text-center">
          ...
          <p className="text-red-600 font-bold tracking-tight">
            Access Protocol Failure: Records unreachable.
          </p>
        </div>
      ) : (
        <div className="bg-white rounded-[40px] premium-shadow border border-slate-100/60 overflow-hidden">
          <DataTable
            ...
            placeholder="Search by practitioner identity..."
          />
        </div>
      )}
        ...
        <form onSubmit={handleSubmit} className="space-y-8 pt-4">
          ...
          <div className="flex justify-end gap-3 pt-4">
            ...
            <button
              ...
              className="h-14 px-10 bg-slate-900 hover:bg-teal-600 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-xl transition-all active:scale-95 disabled:opacity-50"
            >
